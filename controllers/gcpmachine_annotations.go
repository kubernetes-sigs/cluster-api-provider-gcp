...
func (r *GCPMachineReconciler) updateMachineAnnotationJSON(machine *infrav1.GCPMachine, annotation string, content map[string]interface{}) error {
...
// `content`.
func (r *GCPMachineReconciler) updateMachineAnnotation(machine *infrav1.GCPMachine, annotation string, content string) {
	// Get the annotations
...
func (r *GCPMachineReconciler) machineAnnotationJSON(machine *infrav1.GCPMachine, annotation string) (map[string]interface{}, error) {
...
func (r *GCPMachineReconciler) machineAnnotation(machine *infrav1.GCPMachine, annotation string) string {
