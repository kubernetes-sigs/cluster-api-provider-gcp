...
func (s *Service) Delete(ctx context.Context) error {
	...
	if _, err := s.instanceGroupManagers.Get(ctx, igmKey); err != nil {
	...
	log.V(2).Info("found instanceGroupManager; will delete")

	log.V(2).Info("Deleting instanceGroupManager")
	return gcperrors.IgnoreNotFound(s.instanceGroupManagers.Delete(ctx, igmKey))
}
