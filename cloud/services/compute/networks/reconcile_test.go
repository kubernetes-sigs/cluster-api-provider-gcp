	...
	tests := []testCase{
		...
		},
		{
			...
			mockNetwork: &cloud.MockNetworks{
				...
				GetHook: func(ctx context.Context, key *meta.Key, m *cloud.MockNetworks) (bool, *compute.Network, error) {
	...
	tests := []testCase{
		{
			...
			mockRouter: &cloud.MockRouters{
				...
				GetHook: func(ctx context.Context, key *meta.Key, m *cloud.MockRouters) (bool, *compute.Router, error) {
