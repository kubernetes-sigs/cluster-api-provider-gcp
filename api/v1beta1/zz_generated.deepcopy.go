...
func (in *LoadBalancer) DeepCopyInto(out *LoadBalancer) {
	*out = *in
	...
	if in.CreateBootstrapInstanceGroup != nil {
		in, out := &in.CreateBootstrapInstanceGroup, &out.CreateBootstrapInstanceGroup
		*out = new(bool)
		**out = **in
	}
}
...
func (in *Network) DeepCopyInto(out *Network) {
	*out = *in
	...
	if in.APIInternalBootstrapInstanceGroup != nil {
		in, out := &in.APIInternalBootstrapInstanceGroup, &out.APIInternalBootstrapInstanceGroup
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
