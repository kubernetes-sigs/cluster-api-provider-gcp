...
In the interest of getting new people involved, we have issues marked as [`good first issue`][good_first_issue].

Although These issues have a smaller scope but are very helpful in getting acquainted with the codebase.
